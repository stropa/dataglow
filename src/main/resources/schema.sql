...
CREATE SEQUENCE IF NOT EXISTS USER_ACCOUNT_IDS;
...
CREATE TABLE IF NOT EXISTS CUBE_DESCRIPTION (
ID                BIGINT NOT NULL PRIMARY KEY,
...
CREATE SEQUENCE IF NOT EXISTS CUBE_DESCRIPTION_IDS;
...
CREATE SEQUENCE IF NOT EXISTS REPORT_CONFIG_IDS;
